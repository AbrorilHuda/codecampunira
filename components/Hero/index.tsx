            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="dark:text-body-color-dark mb-12 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl">
                  An accredited software development and engineering community
                  in <b>Pamekasan</b>, East Java. codecamp is a technology
                  community at the{" "}
                  <b>University of Madura Informatics program</b>. We aim to
                  increase educational activities on campus and off campus.
                </p>
